 ...
 * ishika@umich.edu
 *
 * Functions for the shape Triangle
 */
...
Triangle::Triangle() {
    ...
    vertexOneColor.setRed(0);
    vertexOneColor.setGreen(0);
    vertexOneColor.setBlue(0);

    vertexTwoColor.setRed(0);
    vertexTwoColor.setGreen(0);
    vertexTwoColor.setBlue(0);

    vertexThreeColor.setRed(0);
    vertexThreeColor.setGreen(0);
    vertexThreeColor.setBlue(0);
}
...
void Triangle::read(istream& ins) {
    ...
    //if that doesn't work, tries different format
    if (ins.fail()) {
        ins.clear();
    ...
    //if it does work, it finishes that format
    else {
